...
namespace UnitTestATMExercise
{
    ...
    class CalculatorTests
    {
        ...
        */
        ...
        [TestCase("ACR101", 40000, 40000, 8000, "20151006213456001", "ACR101", 40000, 40100, 8000, "20151006213457001", 100)]
        // Plane moved 100 m south in 1000 milliseconds (backwards), 40100 to 40000, expected 100 meter/second
        [TestCase("ACR101", 40000, 40100, 8000, "20151006213456001", "ACR101", 40000, 40000, 8000, "20151006213457001", 100)]

        // Plane not moved ***      Time need to be checked if the plane hasn't moved           *******
        [TestCase("ACR101", 40000, 40000, 8000, "20151006213456001", "ACR101", 40000, 40000, 8000, "20151006213457001", 0)]
        ...
        [TestCase("ACR101", 40000, 40000, 8000, "20151006213456001", "ACR101", 40300, 40400, 8000, "20151006213458001", 250)]
        ...
        [TestCase("ACR101", 40300, 40400, 8000, "20151006213456001", "ACR101", 40000, 40000, 8000, "20151006213458001", 250)]
